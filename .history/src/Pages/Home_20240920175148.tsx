  ...
  return (
    ...
    <div className=" flex  gap-20 justify-center  h-[35rem ] max-md:flex-col ">
      ...
      <div className="w-1/2 justify-center items-center  mt-20  max-sm:w-full">
        ...
        <h1 className="text-6xl mb-5 text-white font-bold max-md:text-5xl">Delivery food from best Restaurants</h1>
        <div className="justify-between">
         <div className="mb-10 rounded-lg bg-white w-2/3 p-2 justify-between items-center max-sm:w-full max-sm:items-stretch">
         <input type="text" placeholder="Food and restaurant " className=" flex-grow p-1 outline-none max-sm:w-1/2"></input>
