...
const Navbar: React.FC = () => {
  ...
  const [menu , setMenu]= useState<JSX.Element>(<IoReorderThreeOutline/>)
  ...
  const handleMenu = () => {
    setMenu(prevMenu =>
      prevMenu.type === IoReorderThreeOutline ? <IoReorderThreeOutline className="bg-orange-500  p-2 rounded-full" /> : <IoReorderThreeOutline/>
    );
  };
  ...
  return (
    <div className=" mt-2 flex justify-between text-white">
      ...
      <div className="flex justify-center items-center">
        ...
        <IoReorderThreeOutline className="bg-orange-500  p-2 rounded-full" onClick={handleMenu}  />
        </div>
