...
const Home: React.FC = () => {
  return (
    ...
    <div className=" flex  gap-20 justify-center  h-[35rem]">
      ...
      <div className="w-1/2 justify-center items-center  mt-20 ">
        ...
        <h1 className="text-6xl mb-5 text-white font-bold max-md:text-3xl">Delivery food from best Restaurants</h1>
