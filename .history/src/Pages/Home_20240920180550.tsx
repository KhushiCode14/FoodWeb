...
">
            <Link to="https://www.facebook.com/"><FaFacebookF size={30} className="bg-orange-500  text-black rounded-full font-extrabold  p-2" />
            </Link>
            <Link to="https://www.twitter.com/"> < CiTwitter size={30} className="bg-orange-500  p-2 rounded-full" />
            </Link>
            <Link to="https://www.instagram.com/">  <FaInstagram size={30} className="bg-orange-500  p-2 rounded-full" />
            </Link>
