...
const Home: React.FC = () => {
  return (
    ...
    <div className=" flex  gap-20 bgBack justify-center items-center  ">

      <div className="w-1/2 justify-center items-center m-4 ">
        <h3 className="font-cursive">Best food in town</h3>
