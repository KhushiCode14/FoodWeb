...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="mt-2 flex justify-between items-center text-white  p-4">
          ...
          <ul className="flex flex-col">
            {navLinks.map((link, index) => (
              <li key={index} className="my-1">
                <Link to={link.to} className="block px-4 py-2 text-white text-1xl  hover:bg-orange-200 rounded">
                  {link.linkName}
                </Link>
              </li>
            ))}
